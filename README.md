...
A real-time collaborative notes application built with React 19, TypeScript, and modern tooling. This app demonstrates state management, UI responsiveness, and handling concurrent edits efficiently using CRDT (Conflict-free Replicated Data Types).
